            ...
            <div class="vertical-center-element">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-8">
                            <form class="search-bar search-bar--big" action="https://www.studocu.com/">
                                <i class="fa fa-search search-bar__icon"></i>
                                <input type="search" placeholder="Search for Exams" data-test-selector="big-search-field" value="" data-hj-whitelist="true">
