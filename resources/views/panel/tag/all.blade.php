@php
    $breadcrumb_array = [];
    array_push($breadcrumb_array,collect(['is_last'=>true,'name'=>'عرض التاجات','link'=> '#']));
    array_push($breadcrumb_array,collect(['is_last'=>false,'name'=>'التاجات','link'=> route('panel.tag.all')]));
@endphp
@extends('panel.layouts.index',['sub_title'=>'التاجات' ,'breadcrumb_array'=> $breadcrumb_array])
@section('main')
    @push('panel_css')
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="tag_table" class="table table-bordered table-hover" data-name="cool-table">
    ...
    <div class="modal fade modal-class" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        {!! Form::open(['id'=>'form','url'=>admin_url('tag/')]) !!}
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">اضافه تاج جديد</h5>
                    ...
                    <div id="modal_body" class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input class="form-control col-md-8" id="name_en" type="text" name="name_en" placeholder="الرجاء ادخال الاسم باللغه الانجليزيه" required>
                            </fieldset>
    ...
    @push('panel_js')
        ...
        <script>
            var url = '{{route('panel.tag.all.data')}}';
