...
@section('main')
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table id="department-table" class="table table-bordered table-hover" data-name="cool-table">
                        <caption class="bottom">
                            <a  title="Edit" style="margin-right: 10px"  href="{{route('panel.department.create')}}"  class="btn btn-primary" > <i class="fa fa-plus icon-btn-margin"></i> اضافه جديد </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary  edit_department_btn"  data-dismiss="modal">
    ...
    @push('panel_js')
        ...
        <script>
            var url = '{{route('panel.department.all.data')}}';
            jQuery(document).ready(function () {
                var tbl = $('#department-table').DataTable({
                    "columnDefs": [
