@php
    ...
    array_push($breadcrumb_array,collect(['is_last'=>false,'name'=>'الفصول الدراسيه','link'=> lang_route('units.semester.all')]));
@endphp
...
@section('main')
    ...
    <div class="content">
        {!! Form::open(['id'=>'form','method'=>'PUT','url'=>route('units.semester.edit',['id'=>$semester->id]),'to'=>lang_route('units.semester.all')]) !!}
                    ...
                    <div class="card-body">
                        ...
                        <fieldset class="form-group">
                            ...
                            <select class="form-control" name="faculty_id" data-placeholder="إختيار الكليه" required>
                                <option value="{{$semester->faculty_id}}" selected >{{get_text_locale($semester['faculty'],'name_ar')}}</option>
