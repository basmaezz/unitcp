@php
    ...
    array_push($breadcrumb_array,collect(['is_last'=>false,'name'=>'الفصول الدراسيه','link'=> route('units.classes.all')]));
@endphp
...
@section('main')
    ...
    <div class="content">
        ...
        {!! Form::open(['id'=>'form','method'=>'POST','url'=>route('units.classes.create'),'to'=>route('units.classes.all')]) !!}
        <div class="row">
            <div class="col-md-8">
