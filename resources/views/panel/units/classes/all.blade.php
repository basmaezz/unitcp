@php
    $breadcrumb_array = [];
    array_push($breadcrumb_array,collect(['is_last'=>true,'name'=>'الفصول الدراسيه','link'=> ('.classes.all')]));
@endphp
@extends('/panel.layouts.index',['sub_title'=>'عرض الفرق الدراسيه' ,'breadcrumb_array'=> $breadcrumb_array])
@section('main')
    @push('/panel_css')
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table id="classes-table" class="table table-bordered table-hover" data-name="cool-table">
                        <caption class="bottom">
                            <a  title="Edit" style="margin-right: 10px"  href="{{route('units.classes.create')}}"  class="btn btn-primary" > <i class="fa fa-plus icon-btn-margin"></i> اضافه جديد </a>
                        ...
                        <tr>
                            ...
                            <th width="15%">الاسم باللغه الانجلييه </th>
    ...
    @push('panel_js')
        ...
        <script>
            var url = '{{route('units.fac-classes.all.data')}}';
            jQuery(document).ready(function () {
                var tbl = $('#classes-table').DataTable({
                    "columnDefs": [
