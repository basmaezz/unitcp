...
@section('main')
                ...
                <div class="table-responsive">
                    ...
                    <table id="semester-table" class="table table-bordered table-hover" data-name="cool-table">
                        <caption class="bottom">
                            <a  title="Edit" style="margin-right: 10px"  href="{{route('units.material.create')}}"  class="btn btn-primary" > <i class="fa fa-plus icon-btn-margin"></i> اضافه جديد </a>
    ...
    @push('panel_js')
        ...
        <script>
            var url = '{{route('units.fac-material.all.data')}}';
