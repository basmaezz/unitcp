@php
    $breadcrumb_array = [];
    array_push($breadcrumb_array,collect(['is_last'=>true,'name'=>'الفصول الدراسيه','link'=> ('panel.classes.all')]));
@endphp
...
@section('main')
                ...
                <div class="table-responsive">
                    ...
                    <table id="classes-table" class="table table-bordered table-hover" data-name="cool-table">
                        <caption class="bottom">
                            <a  title="Edit" style="margin-right: 10px"  href="{{route('panel.classes.create')}}"  class="btn btn-primary" > <i class="fa fa-plus icon-btn-margin"></i> اضافه جديد </a>
    ...
    @push('panel_js')
        ...
        <script>
            var url = '{{route('panel.classes.all.data')}}';
